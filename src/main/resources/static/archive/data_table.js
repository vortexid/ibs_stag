...
var IbsTable = Ractive.extend({    
    ...
    partials: {
        ...
        let table_template = "<table class='ui dividing header' width='100%'><tr><td width='90%'><h3 >{{title}}</h3></td><td align='right'><button id='add_button' class='ui primary button'  on-click='@this.onClickAdd()'>Novo</button></td><td align='left'><button id='remove_button' class='ui primary {{delete_disabled}} button' on-click='@this.onClickDelete()'>Brisati</button></td></tr> \
